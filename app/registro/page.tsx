  ...
  return (
    <div className="mx-auto max-w-3xl">
      <div className="glass rounded-3xl p-6 md:p-8">
        ...
        <h1 className="text-3xl font-bold text-cream">Crea tu cuenta</h1>
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 grid gap-4 md:grid-cols-2">
          <div className="md:col-span-2"><h2 className="mb-2 text-sm font-semibold uppercase tracking-wide text-muted/80">Datos personales</h2></div>
          ...
          {role === "PROFESIONAL" && <>
            <div className="md:col-span-2 mt-2"><h2 className="mb-2 text-sm font-semibold uppercase tracking-wide text-muted/80">Perfil profesional</h2></div>
          ...
          <label className="md:col-span-2 mt-1 flex items-center gap-2 text-sm text-muted"><Checkbox checked={watch("terms")} onCheckedChange={(v) => setValue("terms", !!v)} />Acepto términos y política de privacidad</label>
