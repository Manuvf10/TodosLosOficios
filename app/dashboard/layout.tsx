...
export const metadata: Metadata = {
  title: "Dashboard | TodosLosOficios",
  description: "Gestiona solicitudes, respuestas y perfil desde tu panel.",
};
  ...
  return (
    <section className="grid gap-4 lg:grid-cols-[250px_1fr]">
      <aside className="glass h-fit rounded-2xl p-3 lg:sticky lg:top-20">
        <p className="mb-3 px-2 text-xs font-semibold uppercase tracking-wide text-muted/80">Panel de gestión</p>
