  ...
  return (
    <div className="mx-auto max-w-md">
      <div className="glass rounded-3xl p-6 md:p-8">
        ...
        <p className="mt-2 text-sm text-muted">Entra para revisar solicitudes y presupuestos. No enviamos spam ni compartimos tus datos (demo).</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          ...
          <Button disabled={isSubmitting} className="w-full" size="lg">Entrar a mi panel</Button>
        </form>

        <Button variant="outline" className="mt-3 w-full" disabled={!googleEnabled} title={!googleEnabled ? "Google OAuth no configurado (placeholder)" : "Continuar con Google"}>Continuar con Google (demo)</Button>
      </div>
    </div>
  );
}
