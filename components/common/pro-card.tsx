    ...
    <Card className="group warm-glow overflow-hidden p-0">
      ...
      <div className="space-y-3 p-4">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h3 className="font-semibold text-cream">{pro.name}</h3>
        ...
        <Link href={`/profesional/${pro.id}`} className="inline-flex rounded-lg border border-copper/40 bg-copper/20 px-3 py-2 text-sm text-cream transition hover:bg-copper/30">Ver perfil</Link>
      </div>
    </Card>
  );
}
